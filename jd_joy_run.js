...
[task_local]
# 宠汪汪邀请助力与赛跑助力
15 10 * * * https://raw.githubusercontent.com/taboco/JD-docker/master/jd_joy_run.js, tag=宠汪汪邀请助力与赛跑助力, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdcww.png, enabled=true
[rewrite_local]
# 宠汪汪助力更新Token
^https:\/\/draw\.jdfcloud\.com(\/mirror)?\/\/api\/user\/addUser\?code= url script-response-body https://raw.githubusercontent.com/taboco/JD-docker/master/jd_joy_run.js
# 宠汪汪助力获取Token
^https:\/\/draw\.jdfcloud\.com(\/mirror)?\/\/api\/user\/user\/detail\?openId= url script-request-header https://raw.githubusercontent.com/taboco/JD-docker/master/jd_joy_run.js
=====================Loon=====================
[Script]
...
//下面给出好友邀请助力的示例填写规则
let invite_pins = ['jd_xTGoxiVqFBMg,jd_agiXjgCxIbpq,623685145_m'];
//下面给出好友赛跑助力的示例填写规则
let run_pins = ['jd_xTGoxiVqFBMg,jd_agiXjgCxIbpq,623685145_m'];
//friendsArr内置太多会导致IOS端部分软件重启,可PR过来(此处目的:帮别人助力可得30g狗粮)
let friendsArr = ['jd_xTGoxiVqFBMg,jd_agiXjgCxIbpq,623685145_m']
